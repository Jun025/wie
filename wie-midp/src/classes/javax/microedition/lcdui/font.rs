...
impl Font {
    ...
    async fn get_baseline_position(jvm: &Jvm, _: &mut WieJvmContext, this: ClassInstanceRef<Self>) -> JvmResult<i32> {
        ...
        let height: i32 = jvm.invoke_virtual(&this, "javax/microedition/lcdui/Font", "getHeight", "()I", ()).await?;
...
mod test {
    ...
    fn test_baseline_position() -> Result<()> {
        run_jvm_test(Box::new([get_protos().into()]), |jvm| async move {
            ...
            let height: i32 = jvm.invoke_virtual(&font, "javax/microedition/lcdui/Font", "getHeight", "()I", ()).await?;

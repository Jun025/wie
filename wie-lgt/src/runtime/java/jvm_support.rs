...
pub(crate) mod tests {
    ...
    fn abi_rows_cover_the_indexes_titles_actually_dispatch_on() -> Result<()> {
        ...
        // java/lang/String index 21 and then 27, 월드장기체스 java/lang/String index 16, 간호사타이쿤2 java/io/DataInputStream index 22,
        // 스파이더맨3 java/io/DataInputStream index 27, 슈퍼액션히어로 java/io/DataInputStream index 32, 월드장기체스 java/util/Random index 10. Unlike the rows around them, these were derived from CLDC declaration order

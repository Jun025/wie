...
### 부록 — `wie-wipi-c/src/api/database.rs` `sort_records` doc 주석 이전분 (2026-09-26 · wie-2026-09-19-adoption-audit-prune)

소스 doc 주석에 있던 역공학 노트를 원문 그대로 옮겼다(09-20 추가분 포함). 소스에는 요약 3줄 + 이 절 링크만 남는다.

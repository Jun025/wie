...
★**[2026-09-20 추가] 이 수를 손으로 재유도하지 마라 — `node scripts/corpus-name-inflow.mjs` 로 «다시 잰다»**
(`docs/report/0187` 이 이 산문의 술어를 실행 가능하게 옮겼다 · ★그 도구는 단어 경계로 세 갈래로 가르므로 부분문자열로 센 수와 어긋날 수 있다).

...
- 2026-09-08: **「진행중」의 «맨 위 추가»를 없앴다 — 병은 «맨 위»가 아니라 «지점이 하나»였다**
  ...
  ★**대조군 4셀**: C0 **10/10** · C1(완료만 제거) 6/10 · C2(진행중만 제거) 3/10 · C3(둘 다) ★**0/10**
  ⇒ ★**제안의 「완료를 갈라도 그대로다」는 대체로 맞지만 전부는 아니다**(4/10 은 완료만으로 풀린다) —
  ...
  (직전 판본이 이미 착지한 #100 을 달고 있었다) ⇒ **잃은 서술 0** · §완료 **83건 무접촉 · 순서 변경 0**.
